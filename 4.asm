...
.text	#text section(I still don't know the meaning of that)
...
main:
	...
	li $v0,5
	syscall
	sw $v0,8($t0)		#input operator to $v0 and store it to 8($t0)
	...
	li $v0,5
	syscall
	sw $v0,4($t0)		#read b to $v0 and then store it to 4($t0)
